...
const HeroSection = () => {
	...
	} = getImgProps({ src: '/StartPageHero_1.png', alt: 'Hero Image Desktop', width: '1440', height: '400' })
	const {
		props: { srcSet: mobile },
	} = getImgProps({ src: '/HeroMobile.png', alt: 'Hero Image Mobile', width: '600', height: '400' })
